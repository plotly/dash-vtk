...
function vtk_view(; kwargs...)
        available_props = Symbol[:children, :id, :background, :cameraParallelProjection, :cameraPosition, :cameraViewUp, :className, :clickInfo, :hoverInfo, :interactorSettings, :pickingModes, :style, :triggerRender, :triggerResetCamera]
        wild_props = Symbol[]
