...
vtkVtkPolyData <- function(children=NULL, id=NULL, port=NULL, points=NULL, verts=NULL, lines=NULL, polys=NULL, strips=NULL, pointCloud=NULL, view=NULL, representation=NULL) {
